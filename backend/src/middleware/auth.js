...
export const authorize = (...allowedRoles) => {
  return (req, res, next) => {
    ...
    const roleMapping = {
      ...
      'Laborant': ['Lab', 'Laborant', 'laborant'],
      'chef_laborant': ['chef_laborant', 'ChefLaborant', 'Bosh Laborant'],
      'ChefLaborant': ['chef_laborant', 'ChefLaborant', 'Bosh Laborant'],
      'Bosh Laborant': ['chef_laborant', 'ChefLaborant', 'Bosh Laborant'],
