  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex gap-2 sm:gap-3">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className={`flex-1 px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8 py-2 sm:py-3 ${config.confirmButtonColor} text-white rounded-lg sm:rounded-xl font-semibold transition-colors`}
          >
            {confirmText}
          </button>
        </div>
