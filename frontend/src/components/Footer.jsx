  ...
  return (
    <footer className="bg-white dark:bg-background-dark py-12 sm:py-16 border-t border-[#dbe0e6] dark:border-gray-800">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8 sm:px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-2 lg:col-span-1 flex flex-col gap-3 sm:gap-4 sm:gap-4 sm:gap-6">
            <div className="flex items-center gap-2 sm:gap-2 sm:gap-3 sm:gap-2 sm:gap-3">
              <img 
                src="/image.jpg" 
                alt="Bolajon Klinika Logo" 
                className="size-7 sm:size-9 rounded-lg sm:rounded-lg sm:rounded-xl object-cover shadow-sm"
              />
              <h2 className="text-base sm:text-base sm:text-lg font-black tracking-tight">Bolajon klinikasi</h2>
            </div>
            <p className="text-xs sm:text-sm sm:text-sm sm:text-base text-[#617589] dark:text-gray-400 leading-relaxed">
          ...
          <div>
            <h6 className="font-bold mb-4 sm:mb-6 text-sm sm:text-sm sm:text-base">Tezkor Havolalar</h6>
            <ul className="flex flex-col gap-2 sm:gap-2 sm:gap-3 sm:gap-2 sm:gap-3 text-xs sm:text-sm sm:text-sm sm:text-base text-[#617589] dark:text-gray-400">
          ...
          <div>
            <h6 className="font-bold mb-4 sm:mb-6 text-sm sm:text-sm sm:text-base">Resurslar</h6>
            <ul className="flex flex-col gap-2 sm:gap-2 sm:gap-3 sm:gap-2 sm:gap-3 text-xs sm:text-sm sm:text-sm sm:text-base text-[#617589] dark:text-gray-400">
          ...
          <div>
            <h6 className="font-bold mb-4 sm:mb-6 text-sm sm:text-sm sm:text-base">Aloqa</h6>
            <ul className="flex flex-col gap-2 sm:gap-2 sm:gap-3 sm:gap-2 sm:gap-3 text-xs sm:text-sm sm:text-sm sm:text-base text-[#617589] dark:text-gray-400">
              <li className="flex items-center gap-2 sm:gap-2 sm:gap-3">
              ...
              <li className="flex items-start gap-2 sm:gap-2 sm:gap-3">
                <span className="material-symbols-outlined text-sm sm:text-base mt-0.5">location_on</span>
        ...
        <div className="pt-6 sm:pt-8 border-t border-[#dbe0e6] dark:border-gray-800 flex flex-col sm:flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          ...
          <div className="flex gap-3 sm:gap-4 sm:gap-4 sm:gap-6">
            <a className="text-[#617589] hover:text-primary transition-colors" href="#" aria-label="Website">
              <span className="material-symbols-outlined text-xl sm:text-xl sm:text-2xl">public</span>
            </a>
            <a className="text-[#617589] hover:text-primary transition-colors" href="#" aria-label="Email">
              <span className="material-symbols-outlined text-xl sm:text-xl sm:text-2xl">alternate_email</span>
            </a>
            <a className="text-[#617589] hover:text-primary transition-colors" href="#" aria-label="Phone">
              <span className="material-symbols-outlined text-xl sm:text-xl sm:text-2xl">smartphone</span>
            </a>
          </div>
        </div>
      </div>
