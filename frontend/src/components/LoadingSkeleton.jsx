...
export default function LoadingSkeleton({ type = 'card', count = 1, className = '' }) {
  const skeletons = {
    // Card skeleton
    card: (
      <div className={`bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 ${className}`}>
        <div className="animate-pulse space-y-3 sm:space-y-4">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full"></div>
            <div className="flex-1 space-y-2 sm:space-y-2 sm:space-y-3">
    ...
    // List item skeleton
    list: (
      <div className={`flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-lg sm:rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 ${className}`}>
        <div className="animate-pulse flex items-center gap-3 sm:gap-4 w-full">
    ...
    // Text skeleton
    text: (
      <div className={`animate-pulse space-y-2 sm:space-y-2 sm:space-y-3 ${className}`}>
    ...
    // Stats card skeleton
    stats: (
      <div className={`bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-lg sm:rounded-xl p-4 sm:p-6 ${className}`}>
        <div className="animate-pulse space-y-2 sm:space-y-3">
          <div className="w-12 h-12 bg-gray-300 dark:bg-gray-600 rounded-lg sm:rounded-lg sm:rounded-xl"></div>
