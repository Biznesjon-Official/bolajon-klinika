...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden sm:block px-4 sm:px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      {/* Animated Background */}
      ...
      <div className="w-full max-w-sm sm:max-w-md relative z-10">
        ...
        {/* Login Card */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-white/20 dark:border-gray-700/50 animate-slideUp">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            {/* Username */}
            <div className="space-y-2 sm:space-y-2 sm:space-y-3">
              <label htmlFor="username" className="block text-sm sm:text-sm sm:text-base font-bold text-gray-700 dark:text-gray-200">
                Login
              </label>
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-xl sm:rounded-2xl opacity-0 group-focus-within:opacity-20 blur transition-opacity"></div>
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="relative w-full pl-12 pr-4 py-3 sm:py-4 bg-gray-50/50 dark:bg-gray-700/50 border-2 border-gray-200 dark:border-gray-600 rounded-xl sm:rounded-2xl focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400 font-medium"
            ...
            {/* Password */}
            <div className="space-y-2 sm:space-y-2 sm:space-y-3">
              <label htmlFor="password" className="block text-sm sm:text-sm sm:text-base font-bold text-gray-700 dark:text-gray-200">
                Parol
              </label>
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-xl sm:rounded-2xl opacity-0 group-focus-within:opacity-20 blur transition-opacity"></div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="relative w-full pl-12 pr-12 py-3 sm:py-4 bg-gray-50/50 dark:bg-gray-700/50 border-2 border-gray-200 dark:border-gray-600 rounded-xl sm:rounded-2xl focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400 font-medium"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-red-50 dark:bg-red-900/30 border-2 border-red-200 dark:border-red-800/50 text-red-700 dark:text-red-300 px-4 sm:px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-xl sm:rounded-2xl text-sm sm:text-sm sm:text-base flex items-start gap-2 sm:gap-3 animate-fadeIn backdrop-blur-sm">
                <span className="material-symbols-outlined text-base sm:text-lg mt-0.5">error</span>
            ...
            <button
              type="submit"
              disabled={loading}
              className="relative w-full bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-bold py-3 sm:py-4 px-4 sm:px-4 sm:px-6 lg:px-4 sm:px-6 lg:px-8 rounded-xl sm:rounded-2xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 hover:scale-[1.02] active:scale-[0.98] transform overflow-hidden sm:block group"
            >
              ...
              {loading ? (
                <span className="relative flex items-center justify-center gap-2 sm:gap-2 sm:gap-3">
        ...
        <div className="mt-6 text-center animate-fadeIn" style={{ animationDelay: '0.2s' }}>
          <Link 
            to="/" 
            className="inline-flex items-center gap-2 sm:gap-2 sm:gap-3 text-sm sm:text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors group"
          >
            <span className="material-symbols-outlined text-base sm:text-lg group-hover:-translate-x-1 transition-transform">arrow_back</span>
