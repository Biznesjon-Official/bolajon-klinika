...
export default function MySalary() {
  ...
  return (
    <div className="p-3 sm:p-4 sm:p-4 sm:p-6 lg:p-8 space-y-3 sm:space-y-4 sm:space-y-4 sm:space-y-6">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-green-500 to-teal-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 sm:p-4 sm:p-6 lg:p-8 text-white shadow-xl">
        <div className="flex flex-col sm:flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          <div>
            <h1 className="text-2xl sm:text-2xl sm:text-3xl font-black">MENING MAOSHIM</h1>
            <p className="text-base sm:text-lg opacity-90 mt-1">
              {salaryData.staff.firstName} {salaryData.staff.lastName}
            </p>
            <p className="text-sm sm:text-sm sm:text-base opacity-75">{salaryData.staff.role}</p>
          </div>
          <button
            onClick={loadData}
