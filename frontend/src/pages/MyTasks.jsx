...
export default function MyTasks() {
  ...
  return (
    <div className="p-3 sm:p-4 sm:p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white shadow-xl">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl font-black">Mening Vazifalarim</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 border-yellow-200 dark:border-yellow-800">
          ...
          <p className="text-xl sm:text-2xl font-black text-yellow-600 dark:text-yellow-400">{stats.pending}</p>
        </div>
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 border-green-200 dark:border-green-800">
          ...
          <p className="text-xl sm:text-2xl font-black text-green-600 dark:text-green-400">{stats.in_progress}</p>
        </div>
        <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 border-purple-200 dark:border-purple-800">
          ...
          <p className="text-xl sm:text-2xl font-black text-purple-600 dark:text-purple-400">{stats.completed}</p>
        </div>
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border-2 border-green-200 dark:border-green-800">
          <p className="text-sm sm:text-sm sm:text-base text-gray-600 dark:text-gray-400">Tasdiqlangan</p>
          <p className="text-xl sm:text-2xl font-black text-green-600 dark:text-green-400">{stats.verified}</p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg sm:rounded-xl shadow-sm">
          <div className="p-4 sm:p-6">
            <div className="flex items-center gap-2 sm:gap-3 mb-4">
              <div className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded-lg sm:rounded-lg sm:rounded-xl">
                <span className="material-symbols-outlined text-blue-600 dark:text-blue-400">event_available</span>
              </div>
              <h2 className="text-xl sm:text-2xl font-bold">Navbatdagi smenalarim</h2>
            </div>
            ...
            {shiftsLoading ? (
              ...
              <div className="space-y-2 sm:space-y-3">
                {onDutyShifts.map(shift => (
                  <div
                    key={shift._id}
                    className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-lg sm:rounded-lg sm:rounded-xl p-3 sm:p-4"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 sm:gap-4">
                        <div className="size-14 bg-blue-100 dark:bg-blue-900/40 rounded-full flex items-center justify-center">
                          <span className="material-symbols-outlined text-blue-600 dark:text-blue-400 text-xl sm:text-2xl">
                            event_available
                          </span>
                        </div>
                        <div>
